  ...
  const renderAppCard = (app: AppConfig) => {
    ...
    return (
      <div
        ...
        className="relative overflow-hidden rounded-2xl bg-white border-2 p-6 transition-all duration-300 cursor-pointer hover:shadow-2xl hover:-translate-y-1 border-slate-200 hover:border-blue-300"
      >
